    ...
    return (
        ...
        >
            <View style={[LAYOUT.rounded(22), LAYOUT.p(24), LAYOUT.itemsCenter, LAYOUT.w(width), LAYOUT.h(height), { backgroundColor: "#fff" }]}>
                <Ionicons name={status === "success" ? "checkmark-circle-outline" : status === "warning" ? "alert-circle-outline" : "close-circle-outline" } size={72} color={status === "success" ? "#4CAF50" : status === "warning" ? "orange" : "red"} />
